...
for(i = 0; i < supplyChanges.length; i++){
  //for sanity checks
  //console.log('adding ', supplyChanges[i]);
  ...
  //for sanity checks
  //console.log('totalParts is now '+ totalParts);
}
...
while (parts >= 7){
  ...
  boxesFilled++;
  //for sanity checks
  //console.log('box filled! parts left: ' , parts , ' boxes filled: ' , boxesFilled);
}
